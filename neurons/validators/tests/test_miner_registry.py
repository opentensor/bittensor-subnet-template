...
class TestMinerRegistry(unittest.TestCase):
    ...
    def test_store_miner_metadata(self):
        ...
        # Add a new miner
        registry.store_miner_metadata("key1", "192.168.1.1", "network1", "assets1", "model1")
        # Verify addition
        ...
        registry.store_miner_metadata("key1", "192.168.1.2", "network2", "assets2", "model2")
        # Verify update
    ...
    def test_get_miner_proportion(self):
        ...
        # Add miners
        registry.store_miner_metadata("key1", "192.168.1.1", "network1", "assets1", "model1")
        registry.store_miner_metadata("key2", "192.168.1.2",  "network1", "assets2", "model2")
        registry.store_miner_metadata("key3","192.168.1.3",  "network2", "assets3", "model1")
