...
python3 neurons/validators/validator.py --bitcoin_start_block_height "$BITCOIN_START_BLOCK_HEIGHT" --bitcoin_cheat_factor_sample_size "$BITCOIN_CHEAT_FACTOR_SAMPLE_SIZE" --wallet.name "$WALLET_NAME" --hotkey "$WALLET_HOTKEY" --netuid 15 --subtensor.network finney --logging.debug --logging.trace
