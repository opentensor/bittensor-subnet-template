...
python3 neurons/validators/validator.py --bitcoin_start_block_height "$BITCOIN_START_BLOCK_HEIGHT" --wallet.name "$WALLET_NAME" --hotkey "$WALLET_HOTKEY" --netuid 15 --subtensor.network finney
